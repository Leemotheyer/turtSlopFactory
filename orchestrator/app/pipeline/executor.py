...
from app.pipeline.stages import (
    user_perspective_review as user_perspective_review_stage,
)
...
class PipelineExecutor:
    ...
    async def _stage_user_perspective_review(self, session, project, context) -> bool:
        return await user_perspective_review_stage.stage_user_perspective_review(
